...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        background_mask = 1 - eroded_facemask_tensor

        
        instance_image_tensor = instance_image_tensor * eroded_facemask_tensor.float() + background_noise * background_mask.float() + small_noise * edgemask_tensor.float()
