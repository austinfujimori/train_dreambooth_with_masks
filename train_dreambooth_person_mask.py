...
def collate_fn(examples, with_prior_preservation=False, save_dir="processed_images"):
    ...
    faces = [example["instance_faces"] for example in examples]
    ...
    #     save_image(pixel.float(), os.path.join(save_dir, f"pixel_{idx}.png"))
    #     save_image(face.float(), os.path.join(save_dir, f"face_{idx}.png"))
