...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        facemask = Image.fromarray(facemask_array)
...
def main(args):
    ...
    def process_single_image(instance_image_tensor, blurred_mask):
        ...
        visualization_folder = "visualization_images"
        os.makedirs(visualization_folder, exist_ok=True)
        save_image(instance_image_tensor, os.path.join(visualization_folder, f"processed_only_face.png"))
